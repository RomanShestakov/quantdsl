...
"""
        self.assert_contract_value(specification, 30.00, {'NBP-Jan11': 3.0}, expected_call_count=11)

    def test_simple_forward_market(self):
        specification = """ForwardMarket('NBP', '2012-1-1')"""
        self.assert_contract_value(specification, 10.00, {'NBP-Jan12': 1.0}, expected_call_count=1)
